...
Feature: Syntax HRMS API Workflow
  ...
  Scenario: Retrieving created employee
    ...
    And the retrieved data at "employee" matches the data used to create an employee with employee with employee ID "employee.employee_id"
      | emp_firstname | emp_middle_name | emp_lastname | emp_birthday | emp_gender | emp_job_title   | emp_status |
      | John          | dd              | Cina         | 2021-07-16   | Female     | Cloud Architect | Employee   |